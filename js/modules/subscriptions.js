/* =========================================================
   MoneyFlow — subscriptions.js
   Bills & Subscriptions Module (Vector Icons)
   ========================================================= */
        ...
        <div class="card">
          ...
          <div class="flex flex-col gap-3">
            ${bills.length ? bills.map(b => {
              ...
              return `
                <div class="flex items-center justify-between p-3 border-radius-md" style="background-color: var(--surface-alt); border: 1px solid var(--border);">
                  <div>
      ...
      bodyHTML: `
        <form id="bill-form">
          <div class="form-group">
            ...
            <input type="text" class="form-input" name="name" placeholder="e.g. Home Broadband / EB Bill" required>
          </div>
          <div class="form-group">
      ...
      bodyHTML: `
        <form id="sub-form">
          <div class="form-group">
            ...
            <input type="text" class="form-input" name="name" placeholder="e.g. Netflix / Prime Video / Spotify" required>
          </div>
          <div class="form-group">
            <label class="form-label">Amount (₹)</label>
